    ...
    static {
        ...
        registerService(Context.LINEARMOTOR_VIBRATOR_SERVICE, LinearmotorVibrator.class,
                new CachedServiceFetcher<LinearmotorVibrator>() {
                    @Override
                    public LinearmotorVibrator createService(ContextImpl ctx) throws ServiceNotFoundException {
                        IBinder iBinder = ServiceManager.getServiceOrThrow(Context.LINEARMOTOR_VIBRATOR_SERVICE);
                        ILinearmotorVibratorService service = ILinearmotorVibratorService.Stub.asInterface(iBinder);
